...
- Quests have been added. There's a total of 12 Chapters, 15 if you include the Vanilla Advancement Quests. (Total of 665 Quests.)
...
**Known Issue(s)**
- BetterTitleScreen warning when game is done loading, nothing to worry about just click "Continue to main menu"! (**Probably fixed in the next version**) - (**If not then the mod wasn't updated.**)

- Some transparent blocks appear non-transparent, like spawners. (**Forge Issue**)


**Added**
- [Smooth Scrolling Everwhere](https://www.curseforge.com/minecraft/mc-mods/smooth-scrolling-everywhere)
- [Macaw's Roofs](https://www.curseforge.com/minecraft/mc-mods/macaws-roofs)
- [Big Buckets](https://www.curseforge.com/minecraft/mc-mods/bigbuckets)
- [Magic Mirrors](https://www.curseforge.com/minecraft/mc-mods/magic-mirrors)
- [FPS Reducer](https://www.curseforge.com/minecraft/mc-mods/fps-reducer)
- [Snad](https://www.curseforge.com/minecraft/mc-mods/snad-back-to-the-past)
- [Extra Anvils](https://www.curseforge.com/minecraft/mc-mods/extra-anvils)
- [BeeSourceful](https://www.curseforge.com/minecraft/mc-mods/beesourceful)
- [Extended Furnace](https://www.curseforge.com/minecraft/mc-mods/extended-furnace)
...
- [Angel Block](https://www.curseforge.com/minecraft/mc-mods/angel-block)
- [Super Tools](https://www.curseforge.com/minecraft/mc-mods/super-tools/)
...
- [The Starcilium Mod](https://www.curseforge.com/minecraft/mc-mods/the-starcilium-mod)
- [Click Machine](https://www.curseforge.com/minecraft/mc-mods/click-machine)


**Removed**
- [Permasomnia](https://www.curseforge.com/minecraft/mc-mods/permasomnia) (**Temporarily Removed.**)
...
**Changes**
- Added som CF Scripts to prevent Recipe Conflicts between newly added mods.
- Title Screen Text Update.
- Minor changes. 


**Fixes**
- Breaking animation bug has been fixed. (**By Forge.**)
- Lightning of blocks/items in JEI has been fixed.
- Other minor fixes.
